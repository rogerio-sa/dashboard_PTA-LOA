...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 8660 }, { marker: 'pandoc', elapsed: 360 }, { marker: 'post-processor', elapsed: 60 }, { marker: 'pre-processor', elapsed: 70 }, { marker: 'render', elapsed: 10780 } ];
